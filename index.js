...
const generateDocumentBasedResponse = async (userId, userMessage, documentText) => {
  try {
    ...
    const messages = [
      {
        role: "system",
        content: "You are Date Planner® to assist with planning dates. You offer date ideas, planning tools, and location suggestions to help users create memorable experiences.",
      },
...
const generateRegularResponse = async (userId, userMessage) => {
  try {
    ...
    const messages = [
      {
        role: "system",
        content: "You are Date Planner®,a Smartbot developed by Phoenix Labs under Jmedia Corporation. You are chatbot designed to assist with planning dates. You offer date ideas, planning tools, and location suggestions to help users create memorable experiences.",
      },
      ...conversationHistory, // Include previous conversation history
      {
        role: "user",
